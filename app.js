...
const banks = [
  { name:"СберБанк", deepLink:"sberbankonline://", package:"ru.sberbankmobile" },
  { name:"Т-Банк", deepLink:"tinkoffbank://Main", package:"com.idamob.tinkoff.android" },
  { name:"ВТБ", deepLink:"bank110000000005://", package:"ru.vtb24.mobilebanking.android" },
  { name:"Альфа-Банк", deepLink:"bank100000000008://", package:"ru.alfabank.mobile.android" },
  { name:"Газпромбанк", deepLink:"bank100000000001://", package:"ru.gazprombank.android.mobilebank.app" }
];

function openBank(bank){
  copyTextSync("+" + phone);

  // Важно: переход выполняется немедленно в том же пользовательском клике.
  // Никаких await и setTimeout перед deeplink.
