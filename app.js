...
const banks = [
  {
    name:"СберБанк",
    // Exact Android SBP routes reproduced from the MobiusPay client code.
    // Important: do not "normalize" these into another intent syntax.
    links:[
      `intent://ru.sberbankmobile/payments/p2p?type=phone_number&requisiteNumber=${phone}`,
      `android-app://ru.sberbankmobile/payments/p2p?type=phone_number&requisiteNumber=${phone}`,
      `intent://ru.sberbankmobile/android-app/payments/p2p?type=phone_number&requisiteNumber=${phone}`,
      `sberbankonline://payments/p2p?type=phone_number&requisiteNumber=${phone}`,
      `sberpay://payments/p2p?type=phone_number&requisiteNumber=${phone}`
    ]
  },
  {
    name:"Т-Банк",
