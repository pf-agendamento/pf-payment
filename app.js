...
const banks = [
  {
    name:"СберБанк",
    // Не используем голый sberbankonline:// — такой scheme может перехватить
    // другое установленное приложение. Явно указываем пакет Сбера.
    links:[
      `intent://payments/p2p?type=phone_number&requisiteNumber=${phone}#Intent;scheme=sberbankonline;package=ru.sberbankmobile;end`
    ]
  },
  {
    name:"Т-Банк",
