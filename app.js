...
const DEFAULT_RECIPIENT_BANK_MEMBER_ID = "100000000001";

const rawPhone = params.get("phone") || DEFAULT_PHONE;
const amountRaw = params.get("amount") || "";
const recipientBank = params.get("bank") || DEFAULT_RECIPIENT_BANK;
const recipientBankMemberId =
  params.get("bankMemberId") || DEFAULT_RECIPIENT_BANK_MEMBER_ID;
...
function tbankLinks(){
  const q =
    ...
    `&bankMemberId=${encodeURIComponent(recipientBankMemberId)}` +
